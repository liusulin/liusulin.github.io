...
My research interests are broadly in machine learning and artificial intelligence, with a focus on generative models and probabilistic inference. My recent focus includes:
 - **Diffusion models** [Planning with discrete diffusion, flow matching for scientific simulation]
 - **Amortized inference** [Marginal inference, amortized hyperparameter optimization]
